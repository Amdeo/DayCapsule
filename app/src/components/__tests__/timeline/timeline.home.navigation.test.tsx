...
const mockHomeNavSettingsState = {
  cardSpacing: 'default',
  viewMode: 'timeline',
  setViewMode: jest.fn(),
};
...
jest.mock('@/src/store/settingsStore', () => ({
  useSettingsStore: Object.assign(
    (selector?: (state: any) => any) => (selector ? selector(mockHomeNavSettingsState) : mockHomeNavSettingsState),
    { getState: () => mockHomeNavSettingsState }
  ),
